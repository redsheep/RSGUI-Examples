...
GUIObject=function(game,x,y,width,height){this._bmd=new Phaser.BitmapData(game,'',width,height);Phaser.Sprite.call(this,game,x,y,this._bmd);this._hasTexture=false;this._text=null;this._state='up';this._border=0;this._radius=1;this._originWidth=width;this._originHeight=height;this._extendWidth=0;this._extendHeight=0;this._minWidth=null;this._minHeight=null;this._borderColor='#ccc';this._focus=false;this._autofit=true;this._warp=false;this._font={'family':'Arial','size':16,'color':'#000'};this.inputEnabled=true;this.events.onInputDown.add(this.onInputDownHandler,this);this.events.onInputUp.add(this.onInputUpHandler,this);this.onResize=new Phaser.Signal();this.onFocus=new Phaser.Signal();this.onBlur=new Phaser.Signal();};GUIObject.prototype=Object.create(Phaser.Sprite.prototype);GUIObject.prototype.constructor=GUIObject;GUIObject.prototype.update=function(){this.draw();};GUIObject.prototype.draw=function(){}
GUIObject.prototype.onInputOverHandler=function(sprite,pointer){if(pointer.justReleased())return;if(this.onOverMouseOnly&&!pointer.isMouse)return;if(this.onInputOver)this.onInputOver.dispatch(this,pointer);this._state='over';};GUIObject.prototype.onInputOutHandler=function(sprite,pointer){if(this.onInputOut)this.onInputOut.dispatch(this,pointer);this._state='up';};GUIObject.prototype.onInputDownHandler=function(sprite,pointer){if(this.onInputDown)this.onInputDown.dispatch(this,pointer);this._state='down';this.focus();};GUIObject.prototype.onInputUpHandler=function(sprite,pointer,isOver){if(this.onInputUp)this.onInputUp.dispatch(this,pointer,isOver);if(this.freezeFrames)return;this._state='up';};GUIObject.prototype.focus=function(){this._focus=true;if(this.parent!=null){for(i=0;i<this.parent.children.length;i++){var child=this.parent.children[i];if(child!=this&&child.blur!=null){child.blur();}}}
...
dict.family=data[i];}
return dict;}
GUIObject.prototype.setTheme=function(theme){this._radius=theme.radius;this._color=theme.bgcolor;this.setBorder(theme.border,false);this.setFont(theme.font,false);if(theme.texture!=null)this._hasTexture=true;this.fit(this._autofit);}
...
this._overChild.onInputOutHandler(this._overChild,this.game.input.mousePointer);if(hitChild!=null&&hitChild.events._onInputOver!=null)
...
GUIContainer.prototype.onInputUpHandler=function(sprite,pointer){GUIObject.prototype.onInputUpHandler.call(this,sprite,pointer);if(this._downChild!=null)
...
this._overChild.onInputOutHandler(this._overChild,pointer);this._overChild=null;}
...
ToggleButton=function(game,x,y){GUIObject.call(this,game,x,y);this._minWidth=80;this._onFrame='rsgui-toggle-on';this._offFrame='rsgui-toggle-off';this._btnFrame='rsgui-toggle-btn';this._bgFrame=this._offFrame;this._onColor='#ccc';this._offColor='#999';this._check=false;};ToggleButton.prototype=Object.create(GUIObject.prototype);ToggleButton.prototype.constructor=ToggleButton;ToggleButton.prototype.draw=function(){var b=this._border;var r=this._radius;var w=this._originWidth;var h=this._originHeight;var fontcolor=this._font.color;var font=this.getFont();this._bmd.cls();this._bmd.ctx.lineWidth=b;this._bmd.ctx.strokeStyle=this._borderColor;if(!this._hasTexture){this._bmd.ctx.fillStyle=this._color;this._bmd.ctx.roundRect(b,b,w-2*b,h-2*b,r,true);this._bmd.ctx.fill();this._bmd.ctx.strokeBorder(b);}else{var W=this.game.cache.getImage(this._bgFrame).width;var H=this.game.cache.getImage(this._bgFrame).height;this._bmd.generateNinePatchTexture(this._bgFrame,0,0,w,h,r,W,H);}
this._bmd.ctx.font=font;this._bmd.ctx.fillStyle=fontcolor;this._bmd.ctx.textBaseline="top";this._bmd.ctx.fillText("on",r+b,r+b);this._bmd.ctx.fillText("off",w-r-b-16,r+b);if(!this._hasTexture){this._bmd.ctx.fillStyle=this._bottonColor;if(this._check)this._bmd.ctx.roundRect(w-b-(h-2*b),b,h-2*b,h-2*b,r,true);else this._bmd.ctx.roundRect(b,b,h-2*b,h-2*b,r,true);this._bmd.ctx.fill();this._bmd.ctx.strokeBorder(b);}else{var W=this.game.cache.getImage(this._btnFrame).width;var H=this.game.cache.getImage(this._btnFrame).height;if(this._check){this._bmd.generateNinePatchTexture(this._btnFrame,w-b-(h-2*b),b,h-2*b,h-2*b,r,W,H);}else{this._bmd.generateNinePatchTexture(this._btnFrame,b,b,h-2*b,h-2*b,r,W,H);}}}
...
CheckBox=function(game,x,y,text){GUIObject.call(this,game,x,y);this._seprate=2;this._text=text;this._check=false;this._onFrame="rsgui-checkbox-on";this._offFrame="rsgui-checkbox-off";this._frame=this._offFrame;};CheckBox.prototype=Object.create(GUIObject.prototype);CheckBox.prototype.constructor=CheckBox;CheckBox.prototype.draw=function(){var b=this._border;var r=this._radius;var w=this.width/this.scale.x;var h=this.height/this.scale.y;var c=h+this._seprate;var fontcolor=this._font.color;var font=this.getFont();this._bmd.cls();this._bmd.ctx.strokeStyle=this._borderColor;if(!this._hasTexture){this._bmd.ctx.fillStyle=this._color;this._bmd.ctx.roundRect(b+r,b+r,h-2*r-2*b,h-2*r-2*b,r,true);this._bmd.ctx.fill();if(this._check){this._bmd.ctx.fillStyle=this._checkColor;this._bmd.ctx.beginPath();this._bmd.ctx.arc(h/2,h/2,h/4,0,2*Math.PI);this._bmd.ctx.closePath();this._bmd.ctx.fill();}}else{var W=this.game.cache.getImage(this._frame).width;var H=this.game.cache.getImage(this._frame).height;this._bmd.copy(this._frame,0,0,W,H,0,0,h,h);}
...
RadioBox=function(game,x,y,text){GUIObject.call(this,game,x,y);this._seprate=2;this._text=text;this._check=false;this._onFrame="rsgui-checkbox-on";this._offFrame="rsgui-checkbox-off";this._frame=this._offFrame;this.onChange=new Phaser.Signal();};RadioBox.prototype=Object.create(GUIObject.prototype);RadioBox.prototype.constructor=CheckBox;RadioBox.prototype.draw=function(){var b=this._border;var r=this._radius;var w=this._originWidth;var h=this._originHeight;var c=h+this._seprate;var fontcolor=this._font.color;var font=this.getFont();this._bmd.cls();this._bmd.ctx.strokeStyle=this._borderColor;if(!this._hasTexture){this._bmd.ctx.fillStyle=this._color;this._bmd.ctx.arc(h/2,h/2,h/3,0,2*Math.PI);this._bmd.ctx.fill();if(this._check){this._bmd.ctx.fillStyle=this._checkColor;this._bmd.ctx.beginPath();this._bmd.ctx.arc(h/2,h/2,h/5,0,2*Math.PI);this._bmd.ctx.closePath();this._bmd.ctx.fill();}}else{var W=this.game.cache.getImage(this._frame).width;var H=this.game.cache.getImage(this._frame).height;this._bmd.copy(this._frame,0,0,W,H,0,0,h,h);}
this._bmd.ctx.font=font;this._bmd.ctx.fillStyle=fontcolor;this._bmd.ctx.textBaseline="middle"
this._bmd.ctx.fillText(this._text,c,h/2);}
RadioBox.prototype.onInputDownHandler=function(sprite,pointer){if(this._check)this.uncheck();else this.check();GUIObject.prototype.onInputDownHandler.call(this,sprite,pointer);};RadioBox.prototype.check=function(){this._check=true;this._frame=this._onFrame;if(this.parent!=null){for(i=0;i<this.parent.children.length;i++){var child=this.parent.children[i];if(child!=this&&child.group==this.group){if(child instanceof RadioBox)child.uncheck();}}}}
...
this._selected=this._options[this._over];this._dropdown=false;this._bmd.resize(Math.floor(this.width),2*r+2*b+this._font.size);}else{this._dropdown=true;this._bmd.resize(Math.floor(this.width),this.height+this._font.size*(this._options.length)+4*r+4*b);}
if(this.onInputDown)
this.onInputDown.dispatch(this,pointer);GUIObject.prototype.onInputDownHandler.call(this,sprite,pointer);};DropDown.prototype.setTheme=function(theme){GUIObject.prototype.setTheme.call(this,theme);this._selectColor=theme.select;}
...
DropDown.prototype.setValue=function(array){this._options=array;}
DropDown.prototype.appendValue=function(data){this._options.push(data);}
...
this._bmd.ctx.fill();}else{var W=this.game.cache.getImage(this._bgFrame).width;var H=this.game.cache.getImage(this._bgFrame).height;var TW=this.game.cache.getImage(this._btnFrame).width;var TH=this.game.cache.getImage(this._btnFrame).height;if(this._scrolltype=='vertical'){this._bmd.verticalThreePatchTexture(this._bgFrame,0,0,w,h,r,W,H);this._bmd.copy(this._btnFrame,0,0,TW,TH,0,p,bh,bh);}else{this._bmd.horizontalThreePatchTexture(this._bgFrame,0,0,w,h,r,W,H);this._bmd.copy(this._btnFrame,0,0,TW,TH,p,0,bh,bh);}}}
